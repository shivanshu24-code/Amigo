...
import { Search, UserPlus, Check, X, Users, MessageCircle, Sparkles, Star, Lock } from "lucide-react";
        ...
        return (
            ...
            >
                ...
                {(user.course || user.year) && (
                    <p className="text-sm text-gray-600 font-medium mb-3 flex items-center gap-2 ml-auto">
                ...
                {/* Bio */}
                {user.bio && (
                    <p className="text-sm text-gray-500 line-clamp-2 mb-4 leading-relaxed ml-auto">{user.bio}</p>
                )}
